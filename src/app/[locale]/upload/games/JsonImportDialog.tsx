    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <Button 
                variant="outline" 
                size="sm" 
                className="bg-[#141414] border-[#333] text-[#aaa] hover:text-white hover:border-red-500/50 hover:bg-red-600/5 h-9 px-4 gap-2 transition-all font-bold text-[13px]"
            >
            ...
            <DialogContent className="sm:max-w-[600px] bg-[#1a1a1a] border-[#333] text-white">
                <DialogHeader>
                    <DialogTitle className="text-[18px] font-bold text-white flex items-center gap-2">
                ...
                <div className="grid gap-5 py-4">
                    <div className="bg-[#141414] p-4 rounded-lg text-sm text-[#888] border border-[#222] space-y-3">
                        <div>
                            <p className="font-bold text-[#aaa] mb-1 flex items-center gap-2">
                                <span className="text-red-500">💡</span> For "body" (Full Description):
                            </p>
                            <p className="text-[12px] leading-relaxed">Please use <strong className="text-white">HTML format</strong>. Supported tags: headers, paragraphs, lists, bold, italic, images. Avoid complex styles or inline CSS.</p>
                        </div>
                        <div className="pt-3 border-t border-[#222] mt-3">
                            <p className="font-bold text-[#aaa] mb-2 flex items-center gap-2 text-[12px]">
                                <span className="text-red-500">🤖</span> Using AI? Copy this rule:
                            </p>
                            <div className="flex gap-2 items-center bg-[#0c0c0c] p-3 rounded border border-[#222]">
                                <code className="flex-1 text-[11px] text-red-400 font-mono whitespace-pre-wrap leading-tight">
                                ...
                                <Button
                                    variant="ghost"
                                    size="icon"
                                    className="hover:bg-red-600/10 text-[#444] hover:text-red-500"
                                    onClick={() => {
                    ...
                    <div className="flex justify-end">
                        <Button 
                            ...
                            className="text-[11px] h-8 gap-2 font-bold text-[#666] hover:text-white hover:bg-red-600/10"
                        >
                    ...
                    <Textarea
                        ...
                        className="min-h-[250px] font-mono text-[13px] bg-[#111] border-[#222] text-white focus:border-red-600/50 transition-all rounded-[8px]"
                        value={jsonInput}
                        onChange={(e) => {
                ...
                <DialogFooter className="sm:justify-between bg-[#0c0c0c] -mx-6 -mb-6 p-6 rounded-b-lg border-t border-[#222]">
                    <Button 
                        variant="ghost" 
                        onClick={handlePasteSample} 
                        type="button"
                        className="text-[#444] hover:text-[#888] font-bold text-[12px]"
                    >
                        Load Sample
                    </Button>
                    <div className="flex gap-3">
                        <Button 
                            ...
                            type="button"
                            className="bg-transparent border-[#222] text-[#666] hover:text-white hover:border-[#333] font-bold"
                        >
                            Cancel
                        </Button>
                        <Button 
