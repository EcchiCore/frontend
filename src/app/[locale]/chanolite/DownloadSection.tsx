        ...
        <div className="w-full max-w-5xl mx-auto space-y-16">
            ...
            {latestRelease && (
                <div className="relative group">
                    {/* CHANGED: Green Gradient for Lite */}
                    <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500 to-green-600 rounded-[2rem] blur opacity-40 group-hover:opacity-75 transition duration-1000" />
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-start md:items-center justify-between">
                            <div className="space-y-4">
                                <div className="flex flex-wrap items-center gap-3">
                                    <Badge className="bg-emerald-500/10 text-emerald-400 border-emerald-500/20 px-3 py-1 text-sm">Latest Lite Build</Badge>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                                {recommendedAsset ? (
                                    <Button size="xl" className="h-20 px-8 text-xl rounded-2xl bg-white text-black hover:bg-emerald-50 hover:text-emerald-900 transition-all shadow-[0_0_30px_-5px_rgba(16,185,129,0.4)] group w-full sm:w-auto flex flex-col items-center justify-center gap-1" asChild>
                                    ...
                                    <Button size="xl" className="h-16 px-8 text-lg rounded-2xl bg-white text-black hover:bg-emerald-50 transition-all shadow-lg shadow-white/10 group w-full sm:w-auto" asChild>
                            ...
                            <div className="flex items-center gap-3 w-full md:w-auto">
                                ...
                                <DropdownMenu>
                                    <DropdownMenuTrigger asChild>
                                        <Button className="flex-1 md:flex-none bg-emerald-600 hover:bg-emerald-500 text-white border-none shadow-lg shadow-emerald-900/20 gap-2 min-w-[140px]">
                                            Assets
