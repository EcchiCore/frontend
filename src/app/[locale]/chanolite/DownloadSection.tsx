                    ...
                    <Card className="relative bg-black/50 backdrop-blur-xl border-slate-700/50 p-6 md:p-10 rounded-[2rem]">
                        <div className="flex flex-col md:flex-row gap-8 items-start md:items-center justify-between">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                                {recommendedAsset ? (
                                    <Button className="h-20 px-8 text-xl rounded-2xl bg-white text-black hover:bg-emerald-50 hover:text-emerald-900 transition-all shadow-[0_0_30px_-5px_rgba(16,185,129,0.4)] group w-full sm:w-auto flex flex-col items-center justify-center gap-1" asChild>
                                    ...
                                    <Button className="h-16 px-8 text-lg rounded-2xl bg-white text-black hover:bg-emerald-50 transition-all shadow-lg shadow-white/10 group w-full sm:w-auto" asChild>
