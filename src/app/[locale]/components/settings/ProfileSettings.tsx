      ...
      <div className="space-y-4">
        <div className="form-control">
          <label className="label flex items-center gap-2">
            ...
            <span className="label-text text-base font-medium">{t('username')}</span>
          </label>
          <input
            type="text"
            name="username"
        ...
        <div className="form-control">
          <label className="label flex items-center gap-2">
            ...
            <span className="label-text text-base font-medium">{t('email')}</span>
          </label>
          <input
            type="email"
            name="email"
        ...
        <div className="form-control">
          <label className="label flex items-center gap-2">
            ...
            <span className="label-text text-base font-medium">{t('bio')}</span>
          </label>
          <textarea
            name="bio"
            value={formData.bio}
        ...
        <div className="form-control">
          <label className="label flex items-center gap-2">
            ...
            <span className="label-text text-base font-medium">{t('avatarUrl')}</span>
          </label>
          <input
            type="text"
            name="image"
          ...
          <div className="modal-box max-w-2xl bg-base-100 rounded-xl shadow-xl">
            ...
            <div className="p-6 text-center">
              ...
              <h2 className="text-2xl font-bold mb-2 text-primary">
                {formData.username || t('defaultUsername')}
              </h2>
              <p className="text-base-content/70 mb-4">
                {formData.email || t('defaultEmail')}
              </p>
              <p className="text-base-content whitespace-pre-wrap break-words px-4">
                {formData.bio || t('defaultBio')}
              </p>
            </div>
          </div>
        </div>
